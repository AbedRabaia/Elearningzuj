...
var CoreViewerQRScannerPage = /** @class */ (function () {
    ...
    CoreViewerQRScannerPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-core-viewer-qr-scanner',template:/*ion-inline-start:"/Users/abedrabaia/Desktop/zuj/moodleapp/src/core/viewer/pages/qr-scanner/qr-scanner.html"*/'<ion-header>\n    <ion-navbar core-back-button>\n        <ion-title>{{ title }}</ion-title>\n\n        <ion-buttons end>\n            <button ion-button icon-only (click)="cancel()" [attr.aria-label]="\'core.close\' | translate">\n                <ion-icon name="close"></ion-icon>\n            </button>\n        </ion-buttons>\n    </ion-navbar>\n</ion-header>\n<ion-content>\n</ion-content>\n'/*ion-inline-end:"/Users/abedrabaia/Desktop/zuj/moodleapp/src/core/viewer/pages/qr-scanner/qr-scanner.html"*/,
        }),
